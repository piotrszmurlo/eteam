...
def create_checkout_session(
    price_id: str, user_id: str, upgrade_plan_name: str
    ...
    try:
        return stripe.checkout.Session.create(
            ...
            mode="payment",
            success_url=f"http://localhost:8003/payment_success?user_id={user_id}&upgrade_plan_name={upgrade_plan_name}",
            cancel_url=f"http://localhost:8003/payment_cancel?user_id={user_id}",
        )
